...
function include_partial_from_folder($templateFolder, $templateName, $vars = array())
{
  echo get_partial_from_folder($templateFolder, $templateName, $vars);
}

function get_partial_from_folder($templateFolder, $templateName, $vars = array())
{
  ...
  if($templateFolder)
  	$actionName = $templateFolder.'/_'.$templateName;
  else
