        ...
        <div id="menu-topo">
          ...
          <div class="menu-secoes">
            <ul>
              <li><a class="mt-programas <?php if($site->getType() == 'Programa TVRTB' || $section->getSlug() == 'programas'): ?>sel-programas<?php endif; ?>" href="/programas">Programas</a></li>
              <li><a class="mt-jogos <?php if($section->getSlug() == 'jogos'): ?>sel-jogos<?php endif; ?>" href="/jogos">Jogos</a></li>
              <li><a class="mt-videos <?php if($section->getSlug() == 'videos'): ?>sel-videos<?php endif; ?>" href="/videos">V&iacute;deos</a></li>
              <li><a class="mt-imagens <?php if($section->getSlug() == 'imagens'): ?>sel-imagens<?php endif; ?>" href="/imagens">Imagens</a></li>
              <li><a class="mt-atividades <?php if($section->getSlug() == 'atividades'): ?>sel-atividades<?php endif; ?>" href="/atividades">Atividades</a></li>
              <li><a class="mt-baixar <?php if($section->getSlug() == 'baixar'): ?>sel-baixar<?php endif; ?>" href="/baixar">Baixar</a></li>
              <li><a class="mt-radio <?php if($section->getSlug() == 'radio'): ?>sel-radio<?php endif; ?>" href="/radio">R&aacute;dio</a></li>
              <li><a class="mt-agenda <?php if($section->getSlug() == 'agenda'): ?>sel-agenda<?php endif; ?>" href="/agenda">Agenda</a></li>
              <li><a class="mt-especial <?php if($section->getSlug() == 'especial'): ?>sel-especial<?php endif; ?>" href="/especial">Especial</a></li>
            </ul>
          </div>
        </div>
