              ...
              <div id="modal-dialog" class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <div class="btn-group">
                      <button type="button" class="botoes btn-inicio" id="inicio" href="http://cmais.com.br/vilasesamo/jogos/quebra-cabeca-vila-sesamo"> </button>
                      <button type="button" class="botoes btn-pxfase" id="next"></button>
                      <button type="button" class="botoes btn-pxfase" id="restart" style="display: none;"> </button>
