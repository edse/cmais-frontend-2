          ...
          <div class="capa grid3">
            ...
            <?php if(isset($displays["galeria"]) && count($displays["galeria"])>0): ?>
              ...
              <?php
                ...
                $related = $asset->retriveRelatedAssetsByAssetTypeId(2);
              ?>
              <?php if(count($related)>0): ?>
                <?php foreach($related as $d): ?>
                <a href="<?php echo $d->retriveImageUrlByImageUsage('image-6-b') ?>" rel="lightbox[photos]" title="<?php echo $d->getTitle() ?>"><img src="<?php echo $d->retriveImageUrlByImageUsage('image-6') ?>" /></a>
                <?php endforeach; ?>
              <?php endif; ?>
              </div>
            <?php endif; ?>
