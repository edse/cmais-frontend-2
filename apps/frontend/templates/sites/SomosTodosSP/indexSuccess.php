          ...
          <div class="capa grid3">
            ...
            <?php if(isset($displays["galeria"]) && count($displays["galeria"])>0): ?>
              ...
              <?php if(count($related)>0): ?>
                ...
                <a href="<?php echo $d->retriveImageUrlByImageUsage('original') ?>" rel="lightbox[photos]" title="<?php echo $d->getTitle() ?>"><img src="<?php echo $d->retriveImageUrlByImageUsage('image-6') ?>" /></a>
                <?php endforeach; ?>
              <?php endif; ?>
              </div>
            <?php endif; ?>
