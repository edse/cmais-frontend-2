...
<div class="container">
      ...
      <div class="hero-unit">
        ...
        <div class="col-dir">
          ...
          <div class="menu-jc">
            <a href="#myModal" role="button" data-toggle="modal" class="como">como funciona</a><span>|</span><a class="online"><span class="numero">20</span><span class="seta"></span>pessoas online</a>
          </div>
        </div>
      </div>
            ...
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner">
                  ...
                  <p>Lorem Ipsum é <a href="#" title="simplesmente uma simulação">simplesmente uma simulação</a> de texto da indústria tipográfica e de impressos, e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja de tipos e os embaralhou para fazer um livro de modelos de tipos. Lorem Ipsum sobreviveu não só a cinco séculos, como também ao salto para a editoração eletrônica, permanecendo essencialmente inalterado. Se popularizou na década de 60, quando a Letraset lançou decalques contendo passagens de Lorem Ipsum, e mais recentemente quando passou a ser integrado a softwares de editoração eletrônica como Aldus PageMaker.</p>
                </div>
              </div>
            </div>
