...
<div class="container">
      ...
      <div class="hero-unit">
        ...
        <div class="col-esq">
          ...
          <p>Mais que um jornal, uma tradução das notícias. </br>
        ...
        <div class="col-dir">
          ...
          <div class="menu-jc">
            <a href="#myModal" role="button" data-toggle="modal" class="como">como funciona</a><span>|</span><a class="online"><span class="numero">2000</span><span class="seta"></span>pessoas online</a>
          </div>
        </div>
      </div>
            ...
            <div class="accordion-group">
              <div class="accordion-heading">
                <a class="accordion-toggle ativo" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne" >
                  <i class="icon-user icon-white"></i>Collapsible Group Item #1
                </a>
              </div>
