      ...
      <div class="hero-unit">
        ...
        <div class="col-dir">
          <div class="menu-topo" style="width: 100%;">
            ...
            <span id="tryin-p" style="font-size: 10px;clear: both; float: right; width: 135px;" class="hide">reconectando em <span id="tryin-v" style="margin: 1px; float: right;"></span></span>
            <!--
