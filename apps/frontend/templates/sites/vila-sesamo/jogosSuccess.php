...
<section class="filtro row-fluid">
  ...
  <div class="span12" role="main">
    ...
    <h1><i class="icones-sprite-interna icones-jogos-grande"></i>Jogos</h1>
  ...
  <ul role="contentinfo" id="container" class="row-fluid">
    ...
    <li class="span4 element<?php if(count($assetPersonagens) > 0) echo " " . implode(" ", $assetPersonagens); ?> jogos"> 
      <a href="/<?php echo $site->getSlug() ?>/jogos/<?php echo $d->getSlug() ?>" title="<?php echo $d->getTitle() ?>">
        ...
        <i class="icones-sprite-interna icones-jogos-pequeno"></i>
        <div>
...
<nav id="page_nav">
  <a href="/testes/vilasesamo2/pages/2.html" class="mais">Carregar mais<i class="icones-sprite-interna icone-carregar-branco"></i></a>
</nav>
