  ...
  <nav class="header-bar">
    <div class="content">
      <h1><a href="<?php echo $site->retriveUrl(); ?>" class="<?php echo $classLogo; ?>" title="Vila Sésamo"><img src="http://cmais.com.br/portal/images/capaPrograma/vilasesamo2/logo-vila-menu.png" alt="Vila Sésamo" /></a>
        <?php /*echo $border*/ ?>
      </h1>
      <ul>
