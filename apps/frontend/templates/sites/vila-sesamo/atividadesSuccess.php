...
<script>
  ...
  function vilaSesamoGetContents() {
    $.ajax({
      ...
      data: "page="+contentPage+"&items=9&site=<?php echo $site->getSlug() ?>&siteId=<?php echo (int)$site->id ?>&section=<?php echo $section->getSlug(); ?>&sectionId=<?php echo $section->getId(); ?>",
      beforeSend: function(){
