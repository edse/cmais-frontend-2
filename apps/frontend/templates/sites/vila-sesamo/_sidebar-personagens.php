    ...
    <nav role="navigation" class="span2">
      ...
      <ul class="filtro-personagem">
       <li>
        <div class="inner bel">
          <a href="#" class="btn-bel" data-filter=".bel">
        ...
        <li>
          <div class="inner beto">
            <a href="#" class="btn-beto" data-filter=".beto">
        ...
        <li>
          <div class="inner comecome">
            <a href="#" class="btn-comecome" data-filter=".come-come">
        ...
        <li>
          <div class="inner elmo">
            <a href="#" class="btn-elmo" data-filter=".elmo">
        ...
        <li>
          <div class="inner enio">
            <a href="#" class="btn-enio" data-filter=".enio">
        ...
        <li>
          <div class="inner garibaldo">
            <a href="#" class="btn-garibaldo" data-filter=".garibaldo">
        ...
        <li>
          <div class="inner grover">
            <a href="#" class="btn-grover" data-filter=".grover">
        ...
        <li>
          <div class="inner zoe">
            <a href="#" class="btn-zoe" data-filter=".zoe">
