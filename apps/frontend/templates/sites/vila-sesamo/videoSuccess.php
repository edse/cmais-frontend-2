...
<div id="content">
  <section class="scroll row-fluid">
    <h3><i class="sprite-icon-colorir-med"></i><?php echo $section->getTitle() ?><i class="seta-scroll sprite-scroll-videos"></i></h3>
  </section>
  <section class="filtro row-fluid">
    <h3><i class="sprite-icon-colorir-med"></i><?php echo $section->getTitle() ?><a class="todos-assets"><i class="sprite-btn-voltar-videos"></i><p>todos os vídeos</p></a></h3>
