...
<div id="content">
  ...
  <section class="filtro row-fluid">
    ...
    <div class="conteudo-asset">
      ...
      <div class="asset">
        <img src="http://cmais.com.br/portal/images/capaPrograma/vilasesamo2/escola-pra-cachorro.jpg" alt="personagem" />
      </div>
    </div>
  </section>
  ...
  <section class="pais">
    ...
    <div class="content span12 row-fluid">
      <div class="redes">
        ...
        <a href="//pinterest.com/pin/create/button/" data-pin-do="buttonBookmark" ><img src="//assets.pinterest.com/images/pidgets/pin_it_button.png" style="margin-top:-10px;" alt="Pinterest" /></a>
