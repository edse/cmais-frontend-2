...
<div id="content">
  <section class="scroll row-fluid">
    <h3><i class="sprite-icon-clipes-med"></i>Atividades<i class="seta-scroll sprite-scroll-videos"></i></h3>
  </section>
  <section class="filtro row-fluid">
    <h3><i class="sprite-icon-clipes-med"></i>Atividades<a class="todos-assets"><i class="sprite-btn-voltar-videos"></i><p>todos os jogos</p></a></h3>
