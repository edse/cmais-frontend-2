  ...
  <div class="span12" role="main">
    ...
    <nav role="navigation" class="span2">
      ...
      <ul class="filtro-personagem">
       ...
       <li>
        <div class="inner bel">
          <a href="/vilasesamo2/personagens/bel" class="btn-bel character" data-filter=".bel">
        ...
        <li>
          <div class="inner beto">
            <a href="/vilasesamo2/personagens/beto" class="btn-beto character" data-filter=".beto">
        ...
        <li>
          <div class="inner comecome">
            <a href="/vilasesamo2/personagens/come-come" class="btn-comecome character" data-filter=".come-come">
        ...
        <li>
          <div class="inner elmo">
            <a href="/vilasesamo2/personagens/elmo" class="btn-elmo character" data-filter=".elmo">
        ...
        <li>
          <div class="inner enio">
            <a href="/vilasesamo2/personagens/enio" class="btn-enio character" data-filter=".enio">
        ...
        <li>
          <div class="inner garibaldo">
            <a href="/vilasesamo2/personagens/garibaldo" class="btn-garibaldo character" data-filter=".garibaldo">
        ...
        <li>
          <div class="inner grover">
            <a href="/vilasesamo2/personagens/grover" class="btn-grover character" data-filter=".grover">
        ...
        <li>
          <div class="inner zoe">
            <a href="/vilasesamo2/personagens/zoe" class="btn-zoe character" data-filter=".zoe">
