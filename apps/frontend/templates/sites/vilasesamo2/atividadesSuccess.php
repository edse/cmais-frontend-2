  ...
  <div class="span12" role="main">
    ...
    <nav role="navigation" class="span2">
      ...
      <ul class="filtro-personagem">
       ...
       <li>
        <div class="inner bel">
          <a href="javascript:;" class="btn-bel character" data-filter=".bel">
        ...
        <li>
          <div class="inner beto">
            <a href="javascript:;" class="btn-beto character" data-filter=".beto">
        ...
        <li>
          <div class="inner comecome">
            <a href="javascript:;" class="btn-comecome character" data-filter=".come-come">
        ...
        <li>
          <div class="inner elmo">
            <a href="javascript:;" class="btn-elmo character" data-filter=".elmo">
        ...
        <li>
          <div class="inner enio">
            <a href="javascript:;" class="btn-enio character" data-filter=".enio">
        ...
        <li>
          <div class="inner garibaldo">
            <a href="javascript:;" class="btn-garibaldo character" data-filter=".garibaldo">
        ...
        <li>
          <div class="inner grover">
            <a href="javascript:;" class="btn-grover character" data-filter=".grover">
        ...
        <li>
          <div class="inner zoe">
            <a href="javascript:;" class="btn-zoe character" data-filter=".zoe">
