  ...
  <nav class="header-bar">
    <div class="content">
      <h1><a href="<?php echo $site->retriveUrl(); ?>" class="<?php echo $classLogo; ?>" title="Vila Sésamo"><img src="/portal/images/capaPrograma/vilasesamo2/logo-vila-menu.jpg" alt="Vila Sésamo" /></a>
        <?php //echo $border ?>
      </h1>
      <ul>
