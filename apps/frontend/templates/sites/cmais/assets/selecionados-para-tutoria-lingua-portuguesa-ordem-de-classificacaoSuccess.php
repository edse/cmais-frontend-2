            ...
            <div id="esquerda" class="grid2">
              <div class="contato grid2">
                <div class="contatoWrapper">
                  <a name="topo"></a>
                  <h3 class="tit-pagina grid3">RESULTADO PROCESSO SELETIVO TUTORIA ONLINE PARA LÍNGUA PORTUGUESA EM ORDEM DE CLASSIFICAÇÃO</h3>
                  <p class="titu" style="margin-bottom:20px">Serão ofertadas 225 vagas por ordem de classificação.</p>
