          	  ...
          	  <div class="busca">
          	  	<ul>
          	  	  <?php foreach($sites as $s): ?>
          	  	  	<?php if($s->slug == "rodaviva" || $s->slug == "metropolis") 
          	  	  		$link = "/programas"; 
          	  	  	else if($s->slug == "reisdarua") 
          	  	  		$link = "/episodios/1-temporada";
										else 
											$link = "/videos";
          	  	  	?>
          	  	  	<li><a href="<?php echo $s->retriveUrl().$link?>"> <?php echo $s->getTitle(); ?></strong></a></li>
          	  	  <?php endforeach; ?>
          	  	</ul>
