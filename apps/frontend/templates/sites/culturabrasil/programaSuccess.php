...
<style type="text/css">
  ...
  .row-fluid .span8 h1 { margin:0; color:#333; font-family: 'asapregular',Arial,Helvetica,sans-serif; }
        ...
        <div class="lista-assets span8">
          ...
          <div class="row-fluid" style="margin-left:10px">
            ...
            <div class="span9">
              ...
              <p> Vocalista da banda Eddie elege cinco músicas de discos que se destacaram em 2009. Tem Lucas Santana, Karina Buhr, Cidadão Instigado e Céu. </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/nove-integrantes-e-coisa-pouca-por-moveis-coloniais-de-acaju" title=" Nove integrantes é coisa pouca?, por Móveis Coloniais de Acaju"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
            ...
            <div class="span9">
              ...
              <p> A banda brasiliense organizou uma seleção musical com conjuntos com, no mínimo, nove integrantes. Com Karnak, Banda Mantiqueira e Karnak. </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/sons-porretas-com-a-orquestra-contemporanea-de-olinda" title=" Sons porretas com a Orquestra Contemporânea de Olinda"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
              <h6>Volume máximo&nbsp;</h6>
          ...
          <div class="row-fluid" style="margin-left:10px">
            ...
            <div class="span9">
              ...
              <p> A cantora e compositora paulistana Mallu Magalhães sugere uma playlist em que compositores criam letras a partir da alma feminina. </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/brasil-latino" title=" Brasil latino"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
            ...
            <div class="span9">
              <h2>Brasil latino</h2>
              <p> Tango, bolero, paixão e língua espanhola temperam a seleção musical assinada por Natalia Mallo e Ramiro Murillo, ambos do gatoNegro. </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/zeca-baleiro-e-as-letras-nonsenses" title=" Zeca Baleiro e as letras nonsenses"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
            ...
            <div class="span9">
              ...
              <p> O cantor e compositor Zeca Baleiro seleciona alguns versos curiosos, infames ou inusitados, da música brasileira. Nem Caetano escapa! </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/rock-na-veia-por-nico-fornaglia" title=" Rock na veia, por Nico Fornaglia"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
            ...
            <div class="span9">
              ...
              <p> Diretor de TV promove viagem pela Jovem Guarda, rock psicodélico, progressivo e dos anos 1980. Tem Ronnie Cord, O Bando e Novos Baianos. </p>
            </div>
          </div> </a>
          <a href="http://cmais.com.br/frontend_dev.php/culturabrasil/entrevistas?debug=1/sambas-urbanos-sambas-gostosos" title=" Sambas urbanos, sambas gostosos"> <div class="row-fluid titulo"></div>
          <div class="row-fluid" style="margin-left:10px">
            <div class="span3" style="margin-left:0px">
              <h6>&nbsp;</h6>
