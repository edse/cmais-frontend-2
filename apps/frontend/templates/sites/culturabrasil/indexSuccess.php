  ...
  <div class="container row-fluid">
    ...
    <div class="span4">
      ...
      <div class="box-facebook">
        <fb:like-box href="https://www.facebook.com/culturabrasil" width="280" height="260" show_faces="true" border_color="#DDDDDD" background_color="#FFFFFF" stream="false" header="true"></fb:like-box>
      </div>
    </div>  
    <!-- / facebook -->
