  ...
  function broadcastEnd(){
    var request = $.ajax({
      data: {
        channel_id: 1,
        program_id: 67,
        url_out: 'http://tvcultura.cmais.com.br/teste'
      },
      dataType: 'jsonp',
      success: function(data) {
        eval(data);
        ...
        <div id="conteudo-pagina">
          ...
          <div class="capa grid3">
            ...
            <div id="esquerda" class="grid2">
              ...
              <div id="livestream"><p>Seu browser não suporta Flash.</p></div>
            ...
            <div id="direita" class="grid1">
              ...
              <div class="contato">
                <p style="margin-bottom:20px;"><?php echo $section->getDescription()?></p>
                  ...
                  <div class="linha t3">
                    <label>mensagem até 250 caracteres</label>
                    <textarea name="mensagem" onKeyDown="limitText(this,250,'#textCounter');" style="height:60px"></textarea>
                                        <p class="txt-10"><span id="textCounter">250</span> caracteres restantes</p>
                  </div>
      ...
      $(document).ready(function(){
        ...
        var validator = $('#form-contato').validate({
          ...
          messages:{
            ...
            mensagem: "Digite uma mensagem.Este campo é obrigatório.",
