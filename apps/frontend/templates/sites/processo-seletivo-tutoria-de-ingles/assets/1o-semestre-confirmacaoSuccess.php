            ...
            <div id="esquerda" class="grid2">
              <div class="contato grid2">
                ...
                <p class="titu">O aviso vale para todos os classificados para o curso de Inglês online da EVESP</p>
								<p>Os classificados para trabalhar como Tutor de Inglês online no PRIMEIRO SEMESTRE deverão fazer uma capacitação presencial obrigatória no dia 25 de fevereiro, em período integral. A capacitação se realizará na Capital, em local a ser divulgado.</p>
                <form id="form-contato" method="post" action="http://200.136.27.251/cadastro-de-tutores/submit-fase31.php">
									<input type="hidden" value="t3vazrte5Hq-7LOsZBf6z_w" name="sid" />
                  <input type="hidden" value="od8" name="wid" />
