              ...
              <li class="span12">
                <div class="thumbnail">
                  <div class="caption">
                    ...
                    <p><a href="<?php echo $displays['sobre-o-programa'][0]->retriveUrl() ?>" class="btn btn-small btn-inverse"><i class="icon-chevron-right icon-white"></i> saiba mais</a></p>
                  </div>
                </div>
              </li>
               <?php endif; ?>
              ...
              <li class="span12">
                <div class="thumbnail">
                  <div class="caption">
                    ...
                    <p><a href="<?php echo $displays['como-participar'][0]->retriveUrl() ?>" class="btn btn-small btn-inverse"><i class="icon-chevron-right icon-white"></i> saiba mais</a></p>
                  </div>
                </div>
              </li>
              <?php endif; ?>
