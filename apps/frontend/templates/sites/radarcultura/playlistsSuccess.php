...
<?php include_partial_from_folder('blocks', 'global/menu', array('site' => $site, 'mainSite' => $mainSite, 'section' => $section)) ?>
            ...
            <?php if(count($pager) > 0): ?>
              ...
              foreach($pager->getResults() as $d):
                ...
                <tr>
                  ...
                  <td><a href="/<?php echo $section->getSlug() . '/' . $d->getSlug(); ?>" class="btn btn-mini btn-inverse pull-right" ><i class="icon-list icon-white"></i> ver detalhes </a></td>
                </tr>
              <?php endforeach; ?>
            <?php endif; ?>
            </tbody>
    ...
    <script>
      ...
      if(success == 1){
        ...
        $("#socialAlertError").show();
         setTimeout('$("#socialAlertError").hide();', 10000);
      }
