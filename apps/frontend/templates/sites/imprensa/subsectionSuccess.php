        ...
        <div id="conteudo-pagina">
          ...
          <div class="capa grid3">
            ...
            <div id="direita" class="grid1">
              ...
              <!-- BOX PADRAO Noticia -->
              <?php if(isset($displays["destaque-1"])) include_partial_from_folder('blocks','global/display1c-news', array('displays' => $displays["destaque-1"])) ?>
              <!-- /BOX PADRAO Noticia -->

              <!-- BOX PADRAO Noticia -->
              <?php if(isset($displays["destaque-2"])) include_partial_from_folder('blocks','global/display1c-news', array('displays' => $displays["destaque-2"])) ?>
              <!-- /BOX PADRAO Noticia -->
