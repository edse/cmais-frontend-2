          	...
          	<div class="tudo-metropolis">
          		...
          		<div class="centroRV">
          			<div class="video-interna">
          			    <ul>
          					<li class="voltarJa"><a href="history.back(1);"><span>Voltar</span></a></li>
          				</ul>
          				<div class="boxVideo">
          				...
          				<div class="vejaTambem">
							...
							<?php endforeach; ?>
          					...
          					<div class="publicidade">
	          					<img title="publicidade" alt="publicidade" src="../metropolis/images/lixo-img.jpg">
	          				</div>
	          				-->
          				</div>
          				<?php endif; ?>
								      ...
								      <?php foreach($charges as $k=>$d): ?>
								        <li>
								            <a class="charges_caruso" rel="charges_caruso" href="<?php echo $d->retriveImageUrlByImageUsage("image-6-b") ?>" title="<?php echo $d->getTitle() ?>">
												<img alt="<?php echo $d->getTitle() ?>" src="<?php echo $d->retriveImageUrlByImageUsage("image-1-b") ?>">
											</a>
								        </li>
								      <?php endforeach; ?> 
								    </ul>
