        ...
        <div id="conteudo-pagina">
          ...
          <div class="capa grid3">
            ...
            <div id="esquerda" class="grid2">
              ...
              <?php include_partial_from_folder('blocks','global/share-2c-close', array('site' => $site, 'uri' => $uri, 'close' => 1)) ?>

              <?php if(isset($displays["destaque-playlist"])): ?><?php include_partial_from_folder('blocks','global/display-2c-playlist', array('displays' => $displays["destaque-playlist"])) ?><?php endif; ?>
            ...
            <div id="direita" class="grid1">
              ...
              <div class="box-publicidade grid1">
                <!-- metropolis-homepage-300x250 -->
                <script type='text/javascript'>
                GA_googleFillSlot("metropolis-homepage-300x250");
                </script>
              </div>
              <!-- /BOX PUBLICIDADE -->
