        ...
        <div id="conteudo-pagina">
          ...
          <div class="capa-revista">
            <?php if(isset($displays["destaque-principal"])): ?>
              ...
              <a href="<?php echo $displays["destaque-principal"][0]->retriveUrl() ?>" title="<?php echo $displays["destaque-principal"][0]->getTitle() ?>" target="_blank"><img src="<?php echo $displays["destaque-principal"][0]->retriveImageUrlByImageUsage('original') ?>" alt="<?php echo $displays["destaque-principal"][0]->getTitle() ?>" /></a>
              <?php endif; ?>
            <?php endif ?>
         </div>
