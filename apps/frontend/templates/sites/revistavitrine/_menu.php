          ...
          <div class="menu-vitrine">
            <ul>
              ...
              <li><a href="<?php echo $site->retriveUrl() . $s->getSlug() ?>" title="<?php echo $s->getTitle() ?>"<?php if($section->getSlug() == $s->getSlug()): ?> class="ativo"<?php endif; ?>><?php echo $s->getTitle() ?></a><span></span></li>
              <?php endforeach; ?>
