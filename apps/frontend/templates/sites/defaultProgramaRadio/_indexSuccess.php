        ...
        <div class="box-topo grid3">
          <?php include_partial_from_folder('blocks','global/sections-menu2', array('siteSections' => $siteSections)) ?>
        	<div class="navegacao txt-10">
          	...
          	<span>&gt;</span>
          	<a href="http://culturafm.cmais.com.br/programas" title="Programas">Programas</a>
          	<span>&gt;</span>
        ...
        <!-- CONTEUDO PAGINA -->
				<div id="conteudo-pagina">
					...
					<div id="esquerda" class="grid2">
						...
						<p style="text-align: left;"><?php echo html_entity_decode(nl2br($site->Program->getSchedule()))?></p>
						<?php endif;?>
								...
								<div class="col-esq grid1">
									...
									<div class="paraouvir">
										...
										<div class="box-padrao noticia grid1">
											<!-- <p class="chapeu">Destaque Podcast</p> -->
		                    ...
		                    <?php $audioAssets = $asset->retriveRelatedAssetsByAssetTypeId(4); ?>
												...
												$(document).ready(function(){
												  ...
												  <?php for($i=0; $i<count($audioAssets); $i++): ?>
												    {
												      name:"<?php echo htmlspecialchars($audioAssets[$i]->getTitle()); ?>",
												      description:"<?php echo htmlspecialchars($audioAssets[$i]->getDescription()); ?>",
