  <link rel="stylesheet" href="http://cmais.com.br/portal/css/tvcultura/secoes/defaultPrograma.css" type="text/css" />
    ...
    <link rel="stylesheet" href="http://cmais.com.br/portal/css/tvcultura/sites/jcprimeiraedicao.css" type="text/css" />
          ...
          <div class="capa grid3">
            ...
            <div id="esquerda" class="grid2">
              <div class="contato grid2">
                ...
                <p><?php echo $section->getDescription()?></p>
                  ...
                  <div class="msgErro" style="display:none">
                    ...
                    <div class="boxMsg">
                      <p class="aviso">Sua pergunta não pode ser enviada.</p>
                  ...
                  <div class="msgAcerto" style="display:none">
                    ...
                    <div class="boxMsg">
                      ...
                      <p>Obrigado por participar do programa.</p>
                    </div>
                    <hr />
                  </div>
              ...
              <div class="grade toggle" style="background:none; padding-bottom: 25px;display:none;overflow: hidden;">
                ...
                <form id="form-contato" method="post" action="http://app.cmais.com.br/index.php/tvcultura/jcdebate/participe">
                  <div class="linha t1">
                    <label>nome</label>
                  ...
                  <div class="linha t3 codigo" id="captchaimage">
                    ...
                    <input class="enviar" type="submit" name="enviar" id="enviar" value="enviar pergunta" style="cursor:pointer" />
                ...
                <div class="grade toggle" style="background:none; padding: 25px 0 0 60px; display:none;overflow: hidden;">
