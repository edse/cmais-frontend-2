        ...
        <div id="conteudo-pagina">
        	...
        	<div class="capa grid3">
              ...
              <div class="box-interna grid2">
                  ...
                  <a href="<?php echo $assetNext->retriveUrl() ?>" class="btn proximo" style="width: 110px; background-position: 91px -34px;"> Próxima aula</a>
                  <a href="<?php echo $assetPrev->retriveUrl() ?>" class="btn anterior" style="width: 110px; padding-left: 20px; float: left; margin-left: 7px;"> Aula anterior</a>
								<?php else: ?>
