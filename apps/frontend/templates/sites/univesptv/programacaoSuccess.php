<script type="text/javascript" src="/portal/js/jquery-ui/js/jquery-ui-1.8.11.custom.min.js"></script>
...
<script type="text/javascript">
  ...
  function redirect(d){
  	//self.location.href = './programacao?c=<?php echo $sChannel->getSlug() ?>&d='+d;
	send('univesptv',d);
  }
    ...
    <div id="capa-site">
      ...
      <div id="barra-site">
        ...
        <div class="topo-programa">
          ...
          <h2><a href="<?php echo $site->retriveUrl() ?>"><img title="<?php echo $site->getTitle() ?>" alt="<?php echo $site->getTitle() ?>" src="http://midia.cmais.com.br/programs/daacbfe1f06a778d7a764d6d26e8974456e4575a.png" /></a></h2>
