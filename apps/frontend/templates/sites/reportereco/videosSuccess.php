          	  ...
          	  <div id="todas" class="filho blocos" style="display:block;">
                  ...
                  <?php if(count($pager) > 0): ?>
                    <?php foreach($pager->getResults() as $d): ?>
                    	<?php $videoRelated = $d->retriveRelatedAssetsByAssetTypeId(6); ?>
          	  	  	<li class="conteudo-lista">
          	  	  	  <a href="<?php echo $d->retriveUrl() ?>" class="bg" title="<?php echo $d->getTitle() ?>"><img class="" src="<?php if ($videoRelated[0]->retriveImageUrlByImageUsage("image-3")) echo $videoRelated[0]->retriveImageUrlByImageUsage("image-3"); else echo $d->retriveImageUrlByImageUsage("image-3"); ?>" alt="<?php echo $d->getTitle() ?>" /><span></span></a>
