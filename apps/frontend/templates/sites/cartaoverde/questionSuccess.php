                      ...
                      <div class="box-padrao box-borda grid1">
                        ...
                        <div class="conteudo enquete">
                          <div class="txt-padrao">
                            ...
                            <div id="form">
                            <form method="post" id="e<?php echo $asset->getId()?>">
                              <?php
                               $form = new BaseForm();
                                    ...
                                    $.ajax({
                                      ...
                                      success: function(data){
                                        $.each(data, function(key, val) {
                                          ...
                                          $('#r<?php echo $asset->getId()?>').append('<div class="porcentagem"><p style="width:'+val.votes+'">'+val.votes+'</p></div>');
                                        });
                                        //alert(data)
                            ...
                            <div id="r<?php echo $asset->getId()?>" class="resultado" style="display:none">
                              <?php /*
                              <p>Opcao 01</p>
