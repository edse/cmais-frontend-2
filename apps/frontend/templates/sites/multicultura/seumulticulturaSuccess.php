          ...
          <div class="box-interna grid2">
            ...
            <?php endif;?>
              ...
              <?php if(isset($displays['enquete'])): ?>
                ...
                <?php $verifica_video = $a[0] -> $displays['enquete'][0]-> Asset -> retriveRelatedAssetsByAssetTypeId(6);
                $verifica_imagem = $a[0] -> $displays['enquete'][0]-> Asset -> retriveRelatedAssetsByAssetTypeId(2); ?>
