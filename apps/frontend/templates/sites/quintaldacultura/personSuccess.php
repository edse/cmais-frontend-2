              ...
              <div class="box-interna grid2">
                ...
                <div class="texto">
                  <?php if($asset->AssetType->getSlug() == "person"): ?>
                    <?php if($asset->retriveImageUrlByImageUsage("image-3") != ""): ?>
                      <img title="<?php echo $asset->getTitle()?>" alt="<?php echo $asset->getTitle()?>" src="<?php echo $asset->retriveImageUrlByImageUsage("image-6-b")?>" /><br />
                    <?php endif; ?>
