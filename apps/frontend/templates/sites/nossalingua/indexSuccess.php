              ...
              <div class="col-esq grid1">
                ...
                <div class="box-padrao grid1">
                  <div class="topo claro">
                    <span></span>
                    <div class="capa-titulo">
                      <h4><?php if(isset($displays["equipe"])) echo $displays["equipe"][0]->Block->getTitle() ?></h4>
                    </div>
                  </div>
                  <?php if(isset($displays["equipe"])) include_partial_from_folder('blocks','global/recent-news', array('displays' => $displays["equipe"])) ?>
                </div>
                <!-- BOX PADRAO Mais recentes -->
                ...
                <div class="box-padrao grid1">
                  <div class="topo claro">
                    ...
                    <div class="capa-titulo">
                      ...
                      <a href="/nossalingua/feed" class="rss" title="rss" style="display: block"></a>
                    </div>
                  </div>
