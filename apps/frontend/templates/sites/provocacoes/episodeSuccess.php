  ...
  <div id="capa-site">
    ...
    <div id="barra-site">
      <div class="topo-programa">
        topo teste <?php if(isset($program) && $program->id > 0):        ?>
                ...
                <div class="veja">
                  ...
                  <div class="vejaTambem">
                    <ul>
                      ...
                      <a class="aTxt" href="<?php echo $d->retriveUrl() ?>"> <span class="nomeRlacionado"><?php echo $d->getTitle()                      ?></span> <!-- span class="nomeTxt"><?php echo $d->getDescription() ?></span--> </a></li>
                      <?php endforeach;?>
                    </ul>
                    <a href=../provocacoes/programas" class="sugestoes"><span>mais vídeos</span></a>
                    </div>
                    <div class="charges">
                    <?php $galeria = $asset -> retriveRelatedAssetsByAssetTypeId(3);
                    ...
                    <li>
                    <a class="fancybox" href="<?php echo $d->retriveImageUrlByImageUsage("image-6-b") ?>" title="<?php echo $d->getTitle()                    ?>" rel="charges_caruso"> <img src="<?php echo $d->retriveImageUrlByImageUsage("image-1-b") ?>" alt="<?php echo $d->getTitle() ?>" /> </a>
                    </li>
                    <?php endforeach;?>
                    </ul>
                  </div>
