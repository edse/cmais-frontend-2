              ...
              <div class="boxLista-video">
                ...
                <div class="centro">
                  <div class="centrowrapper">
                    ...
                    <?php else:?>
                    <a class="imgTumb" href="<?php echo $d->retriveUrl() ?>" title="<?php echo $d->getTitle() ?>"> <img src="/portal/images/capaPrograma/provocacoes/img-padrao.png" alt="<?php echo $d->getTitle() ?>" name="<?php echo $d->getTitle() ?>" /> </a>
                    <?php endif;?>
                    <span class="faixa"></span>
