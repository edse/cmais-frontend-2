            ...
            <div class="centroRV">
              <div class="faleConosco">
                ...
                <div class="box fechado">
                  <p class="icon abre-form">Mande seu poema.</p>
            ...
            <?php endif; ?>
              ...
              <?php if($pager->haveToPaginate()): ?>
                ...
                <div class="paginacao grid3">
                  ...
                  <a class="btn ante" href="javascript: goToPage(<?php echo $pager->getPreviousPage() ?>);">Anterior</a>
                  <ul>
                  ...
                  <a class="btn prox" href="javascript: goToPage(<?php echo $pager->getNextPage() ?>);">Pr&oacute;xima</a>
