            ...
            <div class="accordion-group">
             ...
             <div id="email-central" class="fundo-cinza collapse in" style="overflow: hidden; clear: both;">
              ...
              <div class="row" id="row3">
                ...
                var datas = [
                "<strong style='color:yellow'>Institucional</strong> - Atendimento Central, Área Técnica, Venda de Produtos, Área de Afiliadas, Recrutamento e Seleção.<br/><strong>Emissora (TV ou Rádio)</strong> – Use para contato com programas da grade de programação.<br/><strong>Portal Cmais</strong> – Contato e relatar problemas nos sites do portal.",
