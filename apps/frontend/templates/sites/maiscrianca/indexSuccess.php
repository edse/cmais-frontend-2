  ...
  <div class="row-fluid" id="menu">
    <div class="span12">
      <ul id="myTab" class="nav nav-tabs"> 
        ...
        <li class="diadascriancas"><a href="#diadascriancas" data-toggle="tab"><span></span><p><?php echo $displays['destaque-principal-3'][0]->Block->getTitle() ?></p><span class="ativo"></span></a></li>
          <?php endif; ?>
        <?php endif; ?>
      </ul>
