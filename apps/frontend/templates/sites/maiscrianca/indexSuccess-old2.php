          ...
          <div class="conteudo">
            ...
            <div class="casa">
              ...
              <div class="janelaWrapper">
                ...
                <div class="janela tres">
                  <?php if($displays["destaque-3"][0]->Asset->AssetType->getSlug() == "image"): ?>
                    <a href="<?php echo str_replace(".xtudo", "2.tvcultura", $displays["destaque-3"][0]->retriveUrl())."/x-tudo/" ?>" class="media<?php if($displays["destaque-3"][0]->Asset->AssetType->getSlug() == "video"): ?> video<?php endif; ?>">
              ...
              */ ?>
              ...
              <div class="palhacos">
            	<a href="http://quintaldacultura.com.br" class="palhacosQuintal">quintal da tv</a>
            </div>
              <hr />
            </div>
          </div>
