...
if ($episode) {
	/*
	 ...
	 $descRelated .= "t.name='".$t."' OR a.title like '%".$t."%' OR a.description like '%".$t."%'";
	 }
	 else
	 {
					...
					<div class="tudo-pedroebianca">
						...
						<div class="centro">
							...
							<div class="video-interna">
								<ul>
									<li class="voltarJa">
										<a href="javascript:back()"><span>Voltar</span></a>
									</li>
								</ul>
								<!-- box-videos -->
								<div class="boxVideo">
										...
										<div class="carrossel">
											<ul>
												...
												<li>
													...
													?>
													<a class="aImg<?php if($d->getId() == (int)$asset->id): ?> ativo<?php endif; ?>" href="<?php echo $d->retriveUrl() ?>"> <img src="<?php echo $d->retriveImageUrlByImageUsage("image-2") ?>" alt="<?php echo $d->getTitle() ?>" /> <span class="ico"></span> </a>
													<?php endif;
													?>
													<?php //if($d->retriveLabel() != ""):
													?>
													<a class="aTxt" href="<?php echo $d->retriveUrl() ?>"> <span class="nomeRlacionado"><?php?></span> <?php /* <span class="nomeTxt"><?php echo $d->getDescription() ?></span> */?> </a>
													<?php //endif;?>
												</li>
												<?php endforeach;?>
											</ul>
									...
									<p style="font-size: 10px;">
										<?php echo $asset->AssetVideo->getHeadline()
										?>
									</p>
									<?php endif;?>
									<p class="post">
