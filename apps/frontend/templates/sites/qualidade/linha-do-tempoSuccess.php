        ...
        "date": [
          <?php foreach($pager->getResults() as $d): ?>
            ...
            ?>
            {
                ...
                "text":"<p>1<?php echo trim($d->getDescription())?></p><button class='btn btn-large btn-primary' type='button' onclick='self.location.href=\"<?php echo $d->retriveUrl()?>\"'>Leia mais  &raquo;</button>",
                "asset":
                {
                    "media":"<?php echo $src?>",
