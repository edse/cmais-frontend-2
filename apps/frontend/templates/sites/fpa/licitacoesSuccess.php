    ...
    <div class="col-esquerda span7">
      ...
      <div class="span12" style="margin:0">
        <ul>
          ...
          <li>
            <a href="<?php if(count($s->getAssets()<=0)){echo "javascript:;";}else{echo $s->retriveUrl();} ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo count($s->getAssets())?><?php if(count($s->getAssets())>0){echo "itens";}else{ echo "item";} ?>">
