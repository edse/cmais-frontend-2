          ...
          <div id="destaque" class="destaque grid2 chamada-home">
            <ul class="abas-conteudo conteudo">
              ...
              <li style="display: <?php if($k == 0): ?>block;<?php else: ?>none;<?php endif; ?>" id="bloco<?php echo $k; ?>" class="filho">
                <a class="media titulos" href="<?php echo str_replace("/home/","/",$displays[0]->retriveUrl()) ?>" title="<?php echo $d->getTitle() ?>">
                ...
                <a href="<?php echo str_replace("/home/","/",$displays[0]->retriveUrl()) ?>" class="titulos" title="<?php echo $d->getTitle() ?>"><?php echo $d->getTitle() ?></a>
