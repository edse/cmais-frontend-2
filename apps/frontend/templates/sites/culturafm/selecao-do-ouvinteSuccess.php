...
<div id="capa-site">
  ...
  <div id="barra-site">
    <div class="topo-programa">
      <h2>
      <a href="http://culturafm.cmais.com.br">
      <img title="<?php echo $site->getTitle() ?>" alt="<?php echo $site->getTitle() ?>" src="/portal/images/capaPrograma/culturafm/logo.png">
      </a>
      </h2>
    ...
    <div class="box-topo grid3">
      ...
      <div class="navegacao txt-10">
        ...
        <span>&gt;</span>
        <a href="<?php echo $site->retriveUrl() ?>/<?php echo $section->getSlug()?>" title="<?php echo $section->getTitle()?>">
          ...
          <div class="contato grid2">
            ...
            <form id="form-contato" method="post" action="" class="selecao">
              ...
              <div class="linha add" id="adicionar_holder">
              	<a href="javascript:;" id="adicionar" class="enviar">Sugira mais músicas</a>
              </div>
              ...
              <img src="/portal/js/validate/demo/captcha/images/image.php?1324490004" width="132" height="46" alt="Captcha image" id="captcha_image" />
              </a>
