 ...
 <!-- row-->
  ...
  <ul class="breadcrumb">
     <li><a href="<?php echo $site->retriveUrl() ?>">Cocoricó</a> <span class="divider">&rsaquo;</span></li>
      <li class="active"><a href="<?php echo $site->retriveUrl() ?>/receitinhas">Receitinhas</a> <span class="divider">&rsaquo;</span></li>
  </ul>
  <!-- /breadcrumb-->
  ...
  <div class="tit-pagina">
    ...
    <span></span>
    <!-- RANKING -->
    <?php include_partial_from_folder('sites/cocorico', 'global/ranking', array('section'=>$section[0])) ?>
    <!--/RANKING -->
  </div>
