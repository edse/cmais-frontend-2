 ...
 <!-- row-->
  ...
  <div class="row-fluid conteudo">
    ...
    <div class="span6">
      ...
      <iframe width="460" height="259" src="http://www.youtube.com/embed/<?php echo $related[0]->AssetVideo->getYoutubeId() ?>?wmode=transparent#t=<?php echo $related[0]->AssetVideo->getStartTime() ?>" frameborder="0" allowfullscreen></iframe> 
      <?php endif; ?>
    </div>
  </div>
  <!--/row-->
