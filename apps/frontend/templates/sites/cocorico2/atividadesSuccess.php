...
<div class="container tudo">
  ...
  <div class="row-fluid conteudo">
    ...
    <?php if(isset($displays['destaque-receitinhas'])): ?>
      <?php if(count($displays['destaque-receitinhas']) > 0): ?>
        ...
        <?php $related1 = $displays['destaque-receitinhas'][1]->Asset->retriveRelatedAssetsByRelationType('Preview'); ?>
        <?php $related2 = $displays['destaque-receitinhas'][2]->Asset->retriveRelatedAssetsByRelationType('Preview'); ?>
      <div class="tvcoco span12">
        ...
        <div class="enquete span12">
          <a href="<?php echo $displays['destaque-receitinhas'][1]->retriveUrl() ?>" title="" class="span6"> <img class="span12" src="<?php echo $related1[0]->retriveImageUrlByImageUsage('original') ?>" alt="" /><?php echo $displays['destaque-receitinhas'][1]->getTitle() ?></a>
          <a href="<?php echo $displays['destaque-receitinhas'][2]->retriveUrl() ?>" title="" class="span6 last"> <img class="span12" src="<?php echo $related2[0]->retriveImageUrlByImageUsage('original') ?>" alt="" /><?php echo $displays['destaque-receitinhas'][2]->getTitle() ?></a>
        </div>
      </div>
      <?php endif; ?>
     <?php endif; ?>
  ...
  <div class="row-fluid conteudo">
    ...
    <a href="<?php echo $displays['destaque-imprima'][0]->Asset->retrieveUrl() ?>" title="<?php echo $displays['destaque-imprima'][0]->getTitle() ?>" class="span4 destaque2">
   ...
   <?php endif; ?>
    ...
    <a href="<?php echo $displays['destaque-papel-de-parede'][0]->Asset->retrieveUrl() ?>" title="   <?php echo $displays['destaque-papel-de-parede'][0]->getTitle() ?>" class="span4 destaque2">
