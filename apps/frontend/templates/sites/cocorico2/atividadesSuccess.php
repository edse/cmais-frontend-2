    ...
    <?php if(isset($displays['destaque-receitinhas'])): ?>
      ...
      <div class="tvcoco span12">
        ...
        <?php endif; ?>
          ...
          <a href="<?php echo $displays['destaque-receitinhas'][1]->retriveUrl() ?>" title="" class="span6"> <img class="span12" src="http://img.youtube.com/vi/<?php echo $related1->AssetVideo->getYoutubeId() ?>/1.jpg" alt="" /><?php echo $displays['destaque-receitinhas'][1]->getTitle() ?></a>
          <a href="<?php echo $displays['destaque-receitinhas'][2]->retriveUrl() ?>" title="" class="span6 last"> <img class="span12" src="http://img.youtube.com/vi/<?php echo $related2->AssetVideo->getYoutubeId() ?>/1.jpg" alt="" /><?php echo $displays['destaque-receitinhas'][2]->getTitle() ?></a>
        </div>
      </div>
      <?php endif; ?>
     <?php endif; ?>
