  ...
  <div class="row-fluid conteudo">
    ...
    <?php if(isset($displays['destaque-receitinhas'])): ?>
      ...
      <div class="tvcoco span12">
        ...
        <?php foreach($displays['videos-receitinha'] as $k=>$d):?> 
        <?php $related = $d->retriveRelatedAssetsByAssetTypeId(6); ?>
        <div class="enquete span12">
          <a href="<?php echo $displays['videos-receitinha'][0]->retriveUrl() ?>" title="" class="span6"> <img class="span12" src="http://img.youtube.com/vi/<?php echo $related[0]->AssetVideo->getYoutubeId() ?>/1.jpg" alt="" /><?php echo $displays['videos-receitinha'][0]->getTitle() ?></a>
          <a href="<?php echo $displays['videos-receitinha'][1]->retriveUrl() ?>" title="" class="span6 last"> <img class="span12" src="http://img.youtube.com/vi/<?php echo $related[1]->AssetVideo->getYoutubeId() ?>/1.jpg" alt="" /><?php echo $displays['videos-receitinha'][1]->getTitle() ?></a>
        </div>
      </div>
      <?php endforeach; ?>
      <?php endif; ?>
