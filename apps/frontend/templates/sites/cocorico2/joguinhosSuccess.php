...
<div class="container tudo">
  ...
  <div class="row-fluid conteudo destaques">
    ...
    <div class="span4">
      <a href="<?php echo $assets[0]->retriveUrl() ?>" title="<?php echo $assets[0]->getTitle() ?>"><img class="span12" src="<?php echo $related[0]->retriveImageUrlByImageUsage('image-13') ?>" alt="<?php echo $assets[0]->getTitle() ?>" /></a>
    ...
    <div class="span4">
      <a href="<?php echo $assets[1]->retriveUrl() ?>" title="<?php echo $assets[1]->getTitle() ?>"><img class="span12" src="<?php echo $related[1]->retriveImageUrlByImageUsage('image-13') ?>" alt="<?php echo $assets[1]->getTitle() ?>" /></a>
    ...
    <div class="span4">
      <a href="<?php echo $assets[2]->retriveUrl() ?>" title="<?php echo $assets[2]->getTitle() ?>"><img class="span12" src="<?php echo $related[2]->retriveImageUrlByImageUsage('image-13') ?>" alt="<?php echo $assets[2]->getTitle() ?>" /></a>
