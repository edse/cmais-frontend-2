          ...
          <div id="myCarousel" class="carousel slide span12">
            ...
            <div class="carousel-inner">
              ...
              <div class=<?php if($k==1): ?>active<?php endif; ?> item>
                <a href="<?php echo $d->retrieveUrl() ?>" title="<?php echo $d->getTitle() ?>"><img src="<?php echo $d->Asset->AssetContent->retriveImageUrlByImageUsage('original') ?>" class="<?php echo $d->getTitle() ?>"/></a>
              </div>
            </div>
            	<?php endforeach; ?>
            <!-- Carousel nav -->
