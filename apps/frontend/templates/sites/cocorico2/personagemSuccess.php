    ...
    <div class="span4 autografo">
      <form class="form-horizontal">
        ...
        <div class="control-group g-autografo">
          <a href="http://midia.cmais.com.br/assets/image/original/<?php echo $related_preview[0]->Asset->AssetImage->getFile().".".$related_preview[0]->Asset->AssetImage->getExtension() ?>" title="BAIXAR" target="_blank"><img src="http://midia.cmais.com.br/assets/image/original/<?php echo $related_preview[0]->Asset->AssetImage->getFile().".".$related_preview[0]->Asset->AssetImage->getExtension()?>" alt="BAIXAR" /></a>
          <div class="capa-btn">
            <span></span>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $("#getimage").click(function() {
          if($('#nome').val())
            self.open('http://cmais.com.br/actions/cocorico/image.php?n='+$('#nome').val()+'&u=http://midia.cmais.com.br/assets/image/original/<?php echo $related_download[0]->Asset->AssetImage->getFile().".".$related_download[0]->Asset->AssetImage->getExtension() ?>');
          else
            $('#nome').focus();
        });
      });
