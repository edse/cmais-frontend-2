    ...
    <div class="span8 col-esq">
      ...
      <?php if(isset($displays["conteudos"][0])): ?>
        ...
        <?php if($displays['conteudos'][0]->Asset->AssetType->getSlug() == "video"): ?>
          <h3><a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->Asset->Sections->getSlug() ?>"><?php echo $se[0]->getTitle() ?></a></h3>
          ...
          <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->Asset->Sections->getSlug() ?>"><?php echo $displays["conteudos"][0]->getTitle() ?></a>
          <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->Asset->Sections->getSlug() ?>" class="ico-mais"></a>
        <?php elseif($displays['conteudos'][0]->Asset->AssetType->getSlug() == "content"): ?>
          ...
          <?php if(count($related_image) > 0): ?> 
            ...
            <a href="<?php echo $displays["conteudos"][0]->Asset->retriveUrl() ?>"><img src="http://img.youtube.com/vi/<?php echo $displays["conteudos"][0]->Asset->AssetVideo->getYoutubeId()?>/0.jpg" alt="<?php echo $displays["conteudos"][0]->getTitle() ?>"></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->Asset->Sections->getSlug() ?>"><?php echo $se[0]->getTitle() ?></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->Asset->Sections->getSlug() ?>" class="ico-mais"></a>
