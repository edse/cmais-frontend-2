    ...
    <div class="span8 col-esq">
      ...
      <?php if(isset($displays["conteudos"][0])): ?>
        ...
        <?php if($displays['conteudos'][0]->Asset->AssetType->getSlug() == "video"): ?>
          ...
          <a href="<?php echo $displays["conteudos"][0]->Asset->retriveUrl() ?>"><img src="http://img.youtube.com/vi/<?php echo $displays["conteudos"][0]->Asset->AssetVideo->getYoutubeId()?>/0.jpg" alt="<?php echo $displays["conteudos"][0]->Asset->getTitle() ?>"></a>
        ...
        <?php elseif($displays['conteudos'][0]->Asset->AssetType->getSlug() == "content"): ?>
          ...
          <?php if(count($related_image) > 0): ?> 
            ...
            <a href="<?php echo $displays["conteudos"][0]->Asset->retriveUrl() ?>"><img src="http://img.youtube.com/vi/<?php echo $displays["conteudos"][0]->Asset->AssetVideo->getYoutubeId()?>/0.jpg" alt="<?php echo $displays["conteudos"][0]->Asset->getTitle() ?>"></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->$se ?>"><?php echo $se[0]->getTitle() ?></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->$se ?>" class="ico-mais"></a>
          <?php elseif(count($related_video) > 0): ?> 
            <h3><a href="<?php echo $displays["conteudos"][0]->Asset->retriveUrl() ?>"><?php echo $displays["conteudos"][0]->getTitle() ?></a></h3>
            <a href="<?php echo $displays["conteudos"][0]->Asset->retriveUrl() ?>"><img src="http://img.youtube.com/vi/<?php echo $related_video[0]->AssetVideo->getYoutubeId()?>/0.jpg" alt="<?php echo $displays["conteudos"][0]->Asset->getTitle() ?>"></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->$se ?>"><?php echo $se[0]->getTitle() ?></a>
            <a href="<?php echo $site->retriveUrl().$displays['conteudos'][0]->$se ?>" class="ico-mais"></a>
          <?php endif; ?>
        <?php endif; ?>
