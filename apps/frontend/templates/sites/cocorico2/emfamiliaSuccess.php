      ...
      <?php if(isset($displays['destaque-1'])):?>
        <?php if(count($displays['destaque-1']) > 0): ?>   
          <a title="NA TV" href="/cocorico2/natv" class="video-ytb destaques span6">
            ...
            <p class="bold"><?php $tam=23; $str=$displays['destaque-1'][0]->getTitle(); mb_internal_encoding("UTF-8"); if(strlen($str) <= $tam) echo $str; else echo mb_substr($str, 0, $tam-1)."&hellip;" ?></p>
            <!--p><?php echo $displays['destaque-1'][0]->getDescription() ?></p-->
          </a>
        <?php endif; ?>
     <?php endif; ?>
     ...
     <?php if(isset($displays['destaque-2'])):?>
        <?php if(count($displays['destaque-2']) > 0): ?>   
          <a title="NA WEB" href="/cocorico2/naweb" class="destaques span6 web">
            ...
            <p class="bold"><?php $tam=23; $str=$displays['destaque-2'][0]->getTitle(); mb_internal_encoding("UTF-8"); if(strlen($str) <= $tam) echo $str; else echo mb_substr($str, 0, $tam-1)."&hellip;" ?></p>
