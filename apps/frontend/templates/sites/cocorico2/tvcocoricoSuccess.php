    ...
    <div class="span8 col-esq">
      ...
      <!--  FORM PARA QUANDO TIVE PARTICIPAÇÃO -->
          ...
          <?php elseif($displays['destaque-principal'][0]->Asset->AssetType->getSlug() == "content"): ?>
            ...
            <h2><?php echo $displays['destaque-principal'][0]->getTitle(); ?></h2>
            <img src="<?php echo $displays['destaque-principal'][0]->Asset->retriveImageUrlByImageUsage('image-5-b') ?>" class="destaque-home-tv promocao" alt="<?php echo $displays["destaque-principal"][0]->getTitle() ?>">
