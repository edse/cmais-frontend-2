          ...
          <div class="redes">
            <div class="curtir">
              <fb:like href="<?php echo $section->Site->getFacebookUrl() ?>" layout="button_count" show_faces="false" send="true" width="160"></fb:like>
            </div>
            <a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="<?php echo $section->Site->getTwitterAccount() ?>">Tweet</a>
          </div>
          <!-- /curtir -->
         </div>