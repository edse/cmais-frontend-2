    ...
    <div id="conteudo-pagina">
      ...
      <div class="capa grid3">
        ...
        <div id="direita" class="grid1">
          ...
          <a href="<?php echo $displays["segunda-tela"][0]->getUrl() ?>" title="<?php echo $displays["segunda-tela"][0]->getTitle() ?>" target="_blank" style="display:block; margin-top:30px; margin-bottom:10px"><img src="<?php echo $displays["segunda-tela"][0]->Asset->retriveImageUrlByImageUsage('original') ?>" alt="<?php echo $displays["segunda-tela"][0]->getTitle() ?>" /></a>
              <?php endif; ?> 
            <?php endif; ?>
          <?php endif; ?>
