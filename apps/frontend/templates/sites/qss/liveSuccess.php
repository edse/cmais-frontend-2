    ...
    <div id="conteudo-pagina">
      ...
      <div class="capa grid3">
        ...
        <div id="direita" class="grid1">
          ...
          <a href="<?php echo $displays["segunda-tela"][0]->getUrl() ?>" title="<?php echo $displays["segunda-tela"][0]->getTitle() ?>"><img src="<?php echo $displays["segunda-tela"][0]->Asset->AssetImage->retriveImageUrlByImageUsage('original') ?>" alt="<?php echo $displays["segunda-tela"][0]->getTitle() ?>" /></a>
              <?php endif; ?> 
            <?php endif; ?>
          <?php endif; ?>
