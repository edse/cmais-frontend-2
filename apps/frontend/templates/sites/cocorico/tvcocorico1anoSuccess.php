...
<div class="container tudo">
  ...
  <div class="row-fluid conteudo">
    ...
    <h2><?php echo $displays["destaque-principal"][0]->Asset->getDescription() ?></h2>     
      <img alt="<?php echo $displays["destaque-principal"][0]->getTitle() ?>" src="<?php echo $displays["destaque-principal"][0]->retriveImageUrlByImageUsage("image-5-b") ?>" style="float:left;">
