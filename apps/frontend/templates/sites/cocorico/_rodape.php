<div class="row-fluid rodape" >
    ...
    <div class="span2">
      ...
      <ul>
        ...
        <li><a href="javascript:;" onclick="modalGoTo('http://cmais.com.br/cocorico2/naweb');" data-toggle="modal" title="Na Web">Na Web</a></li>
        <li><a href="javascript:;" onclick="modalGoTo('http://cmais.com.br/cocorico2/agenda');" data-toggle="modal" title="Agenda">Agenda</a></li>
        <li><a href="javascript:;" onclick="modalGoTo('http://www2.tvcultura.com.br/faleconosco/');" data-toggle="modal" title="Fale Conosco">Fale Conosco</a></li>
      </ul>
    </div>
