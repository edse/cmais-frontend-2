...
<div class="row-fluid rodape" >
    ...
    <div class="span2">
      ...
      <ul>
        ...
        <li><a href="#myModal" onclick="javascript:changeUrl('<?php echo $section->Site->retriveUrl() ?>/nocinema', '#myModal a.adulto');" data-toggle="modal" title="Nos Cinemas">No Cinema</a></li>
        <li><a href="#myModal" onclick="javascript:changeUrl('<?php echo $section->Site->retriveUrl() ?>/naweb', '#myModal a.adulto');" data-toggle="modal" title="Na Web">Na Web</a></li>
        <li><a href="#myModal" onclick="javascript:changeUrl('<?php echo $section->Site->retriveUrl() ?>/agenda', '#myModal a.adulto');" data-toggle="modal" title="Agenda">Agenda</a></li>
