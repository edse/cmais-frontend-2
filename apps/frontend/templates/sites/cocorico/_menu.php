...
<div class="navbar-inner">
        <ul class="nav">
          ...
          <li class="joguinhos"><a class="icon" href="/cocorico2/joguinhos" title="Joguinhos"></a><a href="<?php echo $site->retriveUrl() ?>/joguinhos" title="Joguinhos">Joguinhos</a><span></span></li>
          <li class="brincadeiras"><a class="icon"  href="/cocorico2/atividades" title="Brincadeiras"></a><a href="<?php echo $site->retriveUrl() ?>/brincadeiras" title="Brincadeiras">Brincadeiras</a><span></span></li>
          <li class="tvcoco"><a class="icon"  href="/cocorico2/tv-cocorico" title="TV Cocoricó"></a><a href="<?php echo $site->retriveUrl() ?>/tvcocorico" title="TV Cocoricó">TV Cocoricó</a><span></span></li>
          <!--li class="diario"><a class="icon"  href="<?php echo $site->retriveUrl() ?>/diario-do-julio" title="Diário do Júlio"></a><a href="<?php echo $site->retriveUrl() ?>/diario-do-julio" title="Diário do Júlio">Diário do Júlio</a><span></span></li-->
          <li class="familia"><a  href="/cocorico2/emfamilia" title="Em família">Em família</a></li>
        </ul>
     </div>