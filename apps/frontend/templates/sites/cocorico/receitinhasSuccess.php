  ...
  <?php $cont = 0; ?>
    <?php if (count($displays['receitinhas-especiais']) > 0): ?>      
      <?php foreach($displays['receitinhas-especiais'] as $d): ?>
        ...
        <div class="span6">
          <a href="<?php echo $d->retriveUrl() ?>" title="link do jogo"><img class="span12" src="http://img.youtube.com/vi/<?php echo $d[0]->Asset->AssetContent->AssetVideo->getYoutubeId() ?>/0.jpg" alt="<?php echo $d->getTitle() ?>" /></a>
