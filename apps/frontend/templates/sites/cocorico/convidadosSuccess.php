  ...
  <h2 class="tit-pagina">Convidados</h2>
   ...
   <div class="pagination" id="alfabeto">
    <ul>
      ...
      <li<?php if($_REQUEST['letra-cocorico'] == $d): ?> class="active"<?php endif; ?>><a href="/cocorico/tvcocorico/convidados/<?php echo $d ?>" title="<?php echo $d ?>"><?php echo $d ?></a><?php if($k < 26): ?><span class="divider">|</span><?php endif; ?></li>
      <?php endforeach; ?>
    </ul>
