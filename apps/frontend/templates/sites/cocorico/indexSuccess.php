  ...
  <div class="row-fluid conteudo">
    ...
    <div class="span4 col-dir">
      ...
      <div class="tvcoco span12">
        ...
        <h2><i class="icon-star-empty"></i>Agenda Cultural<i class="icon-star-empty"></i></h2>
        ...
        <!--a class="convidado span12" href="http://tvcultura.cmais.com.br/cocorico/tvcocorico/convidados/<?php echo $displays['destaque-tv-cocorico'][0]->Asset->getSlug() ?>" title="<?php echo $displays['destaque-tv-cocorico'][0]->getTitle() ?>"-->
        <a class="convidado span12" href="<?php echo $displays_tv_cocorico['destaque-tv-cocorico'][0]->retriveUrl() ?>" title="<?php echo $displays['destaque-tv-cocorico'][0]->getTitle() ?>"-->
