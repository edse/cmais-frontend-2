  ...
  <div class="row-fluid conteudo">
    ...
    <div class="span4 col-dir">
      ...
      <div class="tvcoco span12">
        ...
        <a class="convidado span12" href="http://tvcultura.cmais.com.br/cocorico/convidados/<?php echo $displays['destaque-tv-cocorico'][0]->getSlug() ?>" title="Próximo convidado: <?php echo $displays['destaque-tv-cocorico'][0]->getTitle() ?>">
