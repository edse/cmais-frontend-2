...
<script type="text/javascript">
  ...
  function redirect(d){
    self.location.href = '<?php echo $site->retriveUrl()?>/programacao?d='+d;
  }
  ...
  function dateLoading(date) { 
    ...
    if (ret == false) {
      ...
      opts=opts +"&program_id=<?php echo $site->Program->getId()?>";
  ...
  <div class="conteudoWrapper" align="center">
    ...
    <div class="conteudo internas">
      <div class="colunaMaior">
        <div class="trilha">
          <p><a href="/">TV Rá Tim Bum</a></p><span>&gt;&gt;</span><a href="/programas">Programas</a><span>&gt;&gt;</span><a href="<?php $site->retriveUrl()?>"><?php $site->getTitle()?></a><span>&gt;&gt;</span><a href="<?php $site->retriveUrl()?>/programacao">Diário de Programação</a>
        </div>
        <div id="box-programas-diarioProgramacao">
          <div class="wrapper">
            ...
            <div class="lista-episodio">
              <p>Diario de programação</p>
            </div>
            <div class="info">
              <p><?php echo $section->getDescription()?></p>
            </div>
            <div class="btn-episodio">
              <span class="pontaBarra"><a href="<?php echo $site->retriveUrl()?>/programacao?d=<?php echo $prevDate ?>"><span class="setaEsquerda">Anterior</span></a></span>
              <span class="nome"><?php echo format_date($date, 'P') ?></span>
              <span class="caudaBarra"><a href="<?php echo $site->retriveUrl()?>/programacao?d=<?php echo $nextDate ?>"><span class="setaDireita">Próximo</span></a></span>
            </div>
      ...
      <div class="coluna">
        ...
        <?php /*
        <hr />
        <div id="box-programas-listaEpisodios">
          <div class="wrapper">
            <div class="topo-esq"></div>
            <div class="topo">
              <a href="" class="enunciado">Lista de Episódios</a>
            </div>
            <div class="epLista">
