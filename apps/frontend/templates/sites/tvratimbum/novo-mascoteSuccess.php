              ...
              <form method="post" id="e<?php echo $a[0]->Asset->getId()?>" class="form-votacao">
                ...
                <ul id="lista-videos">
                  ...
                  <li style="float:<?php if(($i%2 == 0) == 0): echo "right;"; else: echo "left;"; endif;?>">
                    ...
                    <br /><a href="javascript:computavoto('<?php echo $a[$i]->Asset->AssetAnswer->id; ?>');"><?php echo ($i+1)." - ". $opcao?></a>                    
                  </li>
                  <?php endfor;?>
                </ul> 
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      $.each(data, function(key, val) {
        $('.parcial-'+i).html("<li><p>"+(i+1)+" - "+val.aswer+"</p><span>"+val.votes+"</span><div class='progress progress-success'><div class='bar' style='width:"+val.votes+"'></div></div></li>")
        i++;
      });      
    }
  });
