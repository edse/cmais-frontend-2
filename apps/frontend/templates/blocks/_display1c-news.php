                ...
                <div class="box-padrao noticia grid1">
                  ...
                  <?php if($displays[0]->Asset->AssetType->getSlug() == "video"): ?>
                    <a href="<?php echo $displays[0]->retriveUrl() ?>" title="<?php echo $displays[0]->getTitle() ?>">
                      <img src="http://img.youtube.com/vi/<?php echo $displays[0]->Asset->AssetVideo->getYoutubeId() ?>/0.jpg" alt="<?php echo $displays[0]->getTitle() ?>" name="<?php echo $displays[0]->getTitle() ?>" />
                    </a>
                  <?php else: ?>
