              ...
              <?php if(count($displays) > 0): ?>
                <div class="box-padrao grid1">
                  ...
                  <div class="conteudo galeria" style="text-align:center;">
                    ...
                    <?php if(count($imgs) > 0): ?>
                      <?php for($i=0; $i<3; $i++): ?>
                      <li><a href="<?php echo $displays[0]->retriveUrl() ?>/teste"><img alt="<?php echo $imgs[$i]->getTitle() ?>" src="http://midia.cmais.com.br/assets/image/image-3-b/<?php echo $imgs[$i]->AssetImage->getFile() ?>.jpg" /></a>
                        <div class="tooltip">
                          <span></span>
