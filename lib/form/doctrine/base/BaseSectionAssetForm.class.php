...
/**
 * SectionAsset form base class.
 *
 * @method SectionAsset getObject() Returns the current form's model object
 *
 * @package    astolfo
 * @subpackage form
 ...
 */
abstract class BaseSectionAssetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('section_asset[%s]');
