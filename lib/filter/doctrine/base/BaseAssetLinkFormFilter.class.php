...
/**
 * AssetLink filter form base class.
 *
 * @package    astolfo
 * @subpackage filter
 ...
 */
abstract class BaseAssetLinkFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('asset_link_filters[%s]');
