...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'authorized_ip'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'authorized_ip'    => new sfValidatorPass(array('required' => false)),
  ...
  public function addSitesListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('SiteUser.site_id', $values)
    ;
  }

  public function addSectionListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('SectionUser.section_id', $values)
    ;
  }
