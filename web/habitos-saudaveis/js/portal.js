...
cultura = {
  ...
  /*
   * Pega os elementos com a classe "abas" e adiciona a funÃ¯Â¿Â½Ã¯Â¿Â½o.
   * Funcionamento:
   *    Cada elemento de "abas" estÃ¯Â¿Â½ relacionado com um dos elementos "filho" dentro de "abas-conteudo" 
   * 
   */
  "changeAbas" : function(){
    var sel = id = atual = t = "";
    ...
    $('#destaque .abas-menu, #menu-portal .abas-menu').find('a').click(function(){
      ...
      ativaCarrossel();
      //Guarda em uma variÃ¯Â¿Â½vel o bloco onde a funÃ¯Â¿Â½Ã¯Â¿Â½o estÃ¯Â¿Â½ sendo executada. Para que mais de um mÃ¯Â¿Â½dulo possa usar esta funÃ¯Â¿Â½Ã¯Â¿Â½o em uma mesma pÃ¯Â¿Â½gina
      moduloAtual = $(this).parent().parent().parent().parent();
      //Pega o "href" do elemento <a> clicado. Nele contÃ¯Â¿Â½m o "id" do bloco que irÃ¯Â¿Â½ abrir no ".abas-conteudo li" 
    ...
    // FunÃ¯Â¿Â½Ã¯Â¿Â½o setInterval que ativa o carrosel
    function ativaCarrossel(){
      if ($('#destaque ul.abas-menu.pag-bola > li, #menu-portal ul.abas-menu.pag-bola > li').length > 1) {
        window.tCarrossel = setInterval(function(){
          ...
          // Verifica se Ã¯Â¿Â½ o Ã¯Â¿Â½ltimo item para mudar para o primeiro e recomeÃ¯Â¿Â½ar o ciclo
          if ($(atual).is(":last-child")){
            proximo = $("#destaque").find('.abas-menu li:first, abas-conteudo li:first');
          }else{
            proximo = $(atual).next();
          }
          // Simula o click do mÃ¯Â¿Â½todo "changeAbas"
  ...
  "menuTopo" : function(){
    $("ul#menu-portal").find("a.filho").click(function(){
      ...
      // Verifica se o mÃ¯Â¿Â½dulo clicado estÃ¯Â¿Â½ aberto
      if(!$(this).next().is(":visible")){
        // Abre o mÃ¯Â¿Â½dulo clicado
      ...
      // Esconde todos os mÃ¯Â¿Â½dulos quando o mouse desce para o restante da pÃ¯Â¿Â½gina
  ...
  "menuFloat" : function(){
    ...
    */
    ...
    $('.box-lateral').css({'display':'block','position':'fixed','float':'left','width':'34px','height':'275px','top':$('#referencia').offset().top});     
    $(window).scroll(function() {
      //clearTimeout(t);  
      //t = setTimeout(function() {
        ...
        { 
          $('.box-lateral').css({'position':'fixed','top':$('#referencia').offset().top});
        }
        /*
        $('#panel').animate({
          //opacity: 0.25,
