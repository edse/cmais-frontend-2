...
FlashObject = function(swf, id, w, h, ver, c) {
	...
	this.bypassTxt = "<p>Already have Flash Player?<br /><a href='lastdalek/?detectflash=false&%22%2B%20this.sq%20%2B%22'>Click here if you have Flash Player "+ this.version +" installed</a>.</p>";
...
FlashObject.prototype.getHTML = function() {
    ...
    if (window.ActiveXObject && navigator.userAgent.indexOf('Mac') == -1) { // PC IE
        ...
        flashHTML += '<param name="movie" value="lastdalek/%27%20%2B%20this.swf%20%2B%20%27" />';
