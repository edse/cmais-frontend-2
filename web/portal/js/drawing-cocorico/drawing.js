...
var drawingApp = (function () {
    ...
    $(document).ready(function(){
      ...
      $(document).delay(400, function(){
        imgNew = $('.btn-desenho:first').attr('data-source');
        changeDraw(imgNew);
      })
      
      $('.btn-desenho').click(function(){
        $('li.caco').addClass('m0');
        
        $('.btn-desenho').parent().show();
        $(this).parent().hide();
        
        
        if($('li.astolfo').is(":visible")){
          $('li.caco').removeClass('m0');
        }
        
        imgNew = $(this).attr('data-source'); 
        changeDraw(imgNew);
      });
  ...
  var contexts = {},
    ...
    mediumStartX = 72,
    mediumStartY = 76,
    mediumImageWidth = 185,
    mediumImageHeight = 92,
    drawingAreaX = 222,
    drawingAreaY = 22,
    drawingAreaWidth = 534,
    drawingAreaHeight = 478,
    toolHotspotStartY = 46,
    toolHotspotHeight = 76,
    sizeHotspotStartY = 400,
    sizeHotspotHeight = 72,
    sizeLineStartY = 456,
    totalLoadResources = 10, /* se dobrar some*/
    curLoadResNum = 0,
    ...
    swatchImageWidth = 186,
    swatchImageHeight = 92,
    colorLayerData,
    outlineLayerData,
...
/* nao mexi*/
      context.beginPath();
      context.arc(x + 92, y + 46, 36, 0, Math.PI * 2, true);
      context.closePath();
      context.fillStyle = "rgb(" + color.r + "," + color.g + "," + color.b + ")";
      context.fill();

      if (curColor === color) {
        context.drawImage(swatchImage, 0, 0, 118, swatchImageHeight, x, y, 118, swatchImageHeight);
      } else {
    ...
    redraw = function () {
      ...
      var locX,
        ...
        drawCrayon = function (x, y, color, selected) {
          ...
          context.beginPath();
          context.moveTo(x + 82, y + 22);
          context.lineTo(x + 82, y + 70);
          context.lineTo(x + 58, y + 70);
          context.lineTo(x + 58, y + 66);
          context.lineTo(x + 22, y + 54);
          context.lineTo(x + 22, y + 38);
          context.lineTo(x + 58, y + 26);
          context.lineTo(x + 58, y + 22);
          context.lineTo(x + 82, y + 22);
          context.closePath();
          context.fillStyle = "rgb(" + color.r + ", " + color.g + ", " + color.b + ")";
          context.fill();
          ...
          if (selected) {
            ...
            context.drawImage(crayonImage, 0, 0, 118, mediumImageHeight, x, y, 118, mediumImageHeight);
          }
        },
        ...
        drawMarker = function (x, y, color, selected) {
          ...
          if (selected) {
            ...
            context.drawImage(markerImage, 0, 0, 118, mediumImageHeight, x, y, 118, mediumImageHeight);
          }
        };
      ...
      if (curTool === "crayon") {
        ...
        context.drawImage(eraserImage, 36, 38, mediumImageWidth, mediumImageHeight);
...
/* nao mexi*/
    ...
    createUserEvents = function () {
     ...
     //troca desenhos
    changeDraw = function(imgNew){
      if(img!= imgNew){
        img = imgNew;
        //console.log(imgNew);
        contexts.drawing.clearRect(0, 0, drawingAreaWidth, drawingAreaHeight);
        contexts.outline.clearRect(0, 0, drawingAreaWidth, drawingAreaHeight);
        outlineImage.src = img;
      }
    },
