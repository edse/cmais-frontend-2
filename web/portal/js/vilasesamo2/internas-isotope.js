  $(function(){
    ...
    function selectAll(){
      ...
      if(cont != personagens){
        ...
        var filter_selected = "";
        $("#filtrar-tudo").html("Desmarcar todos").css('font-size','0.8em').attr('aria-label','botão para desmarcar todos os personagens filtros');
        ...
        cont=0;
        filter_selected = "";
        $("#filtrar-tudo").html("Marcar todos").attr('aria-label','botão para marcar todos os personagens filtros');
