...
Game.prototype.draw_logo = function() {
  ...
  if(!this.scale) this.scale = 1;
	...
	this.context.drawImage(img, this.canvas.width/this.scale - 200, 50, 200, 100);
...
Game.prototype.draw_remaining = function() {
  ...
  this.context.strokeText("Tempo", 10, 100);
  this.context.fillText("Tempo", 10, 100);
  ...
  this.context.strokeText(this.stage+"/"+this.puzzles.length, (this.canvas.width/this.scale)-200, (this.canvas.height/this.scale)/3);
  this.context.fillText(this.stage+"/"+this.puzzles.length, (this.canvas.width/this.scale)-200, (this.canvas.height/this.scale)/3);
  this.context.restore();
};
...
Game.prototype.draw_loading = function() {
  ...
  this.context.lineWidth = 5;
  this.context.strokeText("LOADING", (this.canvas.width/this.scale), (this.canvas.height/this.scale)/2);
  this.context.fillText("LOADING", (this.canvas.width/this.scale), (this.canvas.height/this.scale)/2);
  //console.log('loading...');
};
