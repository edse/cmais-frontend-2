...
Game.prototype.draw_remaining = function() {
  ...
  this.context.strokeText(this.stage+"/"+this.puzzles.length, (this.canvas.width/this.scale), (this.canvas.height/this.scale)/4);
  this.context.fillText(this.stage+"/"+this.puzzles.length, (this.canvas.width/this.scale), (this.canvas.height/this.scale)/4);
  this.context.restore();
};
