...
if($_REQUEST["captcha"]) {
  if($_REQUEST["cpf"]){
    if(date("Y-m-d H:i:s") < "2013-08-28 00:00:00") {
      if(exec('grep "^'.$_REQUEST["cpf"].'$" /var/frontend/web/tutores-2013/melhor-gestao-melhor-ensino-ciencias-segunda-chamada/control/cpf.txt')){
        die("3");
      }
      else {
        $csvFile = "/var/frontend/web/tutores-2013/melhor-gestao-melhor-ensino-ciencias-segunda-chamada/cadastro.csv";
        ...
        if(fwrite($csvFp, $csvContent)){
          $txtFile = "/var/frontend/web/tutores-2013/melhor-gestao-melhor-ensino-ciencias-segunda-chamada/control/cpf.txt";
          ...
          if(mail($to, $subject, $message, $header)) {
            ...
            $subject = '[Cmais+] Confirmação de cadastro para o processo seletivo de tutor melhor gestão melhor ensino de Ciências - Segunda Chamada';
