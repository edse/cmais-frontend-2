...
if($result->valida_usuarioResult != " " && $result->valida_usuarioResult != ""){
  header("Location: http://cmais.com.br/sic/solicitar-informacoes?step=1&email=".$result->valida_usuarioResult);
}
else{
  header("Location: http://cmais.com.br/sic/solicitar-informacoes");
}
die();
