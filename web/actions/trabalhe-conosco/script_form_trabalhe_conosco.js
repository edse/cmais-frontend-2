    ...
    $.ajax({
      ...
      success: function(json) {
      		if(json.data != null){
	            ...
	            conteudo = conteudo + empresa + ' </font></a>  </div><div id="collapse'+cont+'" class="accordion-body collapse" style="overflow: hidden; clear: both;">';
	            conteudo = conteudo+'<div class="accordion-inner" style="overflow: hidden;clear: both;"><p>Função Inicial: '+funcaoinicial+'</p><p>Função Final:'+funcaofinal+'</p>';
