...
if(isset($_GET['callback']) && !empty($_GET['qg_curric']) && !empty($_GET['qm_codigo']) && !empty($_GET['qm_entidad']) && !empty($_GET['qm_data']) && !empty($_GET['qm_curso']) && !empty($_GET['qm_tcurso']) && !empty($_GET['qm_escolar'])){
