$(document).ready(function() {
  ...
  // retrive contents that were already sent via Ajax
  $.ajax({
    url:"http://cmais.com.br/ajax/fetchurl",
  ...
  window.fakeService = function(){
    ...
    //$('.offline').hide();
    //$('.online').show();
    $('#tryin-p').html("Seu browser não suporta websockets. Você terá uma experiência um pouco diferente da proposta.");
    $('#tryin-p').show();
    $('.offline').html("Erro");
    $('.offline').show();
